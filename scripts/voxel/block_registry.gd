...
static func _ensure_init() -> void:
	...
	_register(1, "grass", false)
	_register(2, "dirt", false)
	_register(3, "sand", false)
	_register(4, "water", false)
	_register(5, "asphalt", false)
	_register(6, "gravel", false)
	_register(7, "concrete_walkway", false)
	_register(8, "bricks", true)
	_register(9, "cement_blocks", false)
	_register(10, "leaves", false)
	_register(11, "shingles_slate", false)
